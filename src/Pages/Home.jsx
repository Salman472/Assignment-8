        ...
        <div>
          <div className='text-center mt-20 space-y-2 w-11/12 mx-auto'>
            ...
            <div className='mt-5 flex justify-center gap-4 mb-3'>
                <Link target='blank' to='https://play.google.com/store/games?hl=en' className='btn btn-outline border-gray-300 shadow-lg hover:scale-105 transition-all duration-500 ease-in-out'><img className='h-8 w-8 rounded-r-sm' src="https://i.ibb.co.com/TJbq64M/images-3.png" alt="" /> Google Play</Link>
                <Link to='https://www.apple.com/app-store/' target='blank' className='btn btn-outline border-gray-300 shadow-lg hover:scale-105 transition-all duration-500 ease-in-out'><img className='h-8 w-8' src="https://i.ibb.co.com/7Jz7JSVZ/App-Store-i-OS-svg.png" alt="" /> App Store</Link>
            </div>
           </div>
           <div className='flex justify-center'>
          <img className=' rounded-4xl hover:scale-102 transition-all duration-500 ease-in-out' src="https://i.ibb.co.com/hJyK67cS/iphone.png" alt="" />
           ...
           <div>
            <div className='text-center mt-20 mb-10 space-y-4'>
                <h1 className='text-5xl text-[#001931] font-bold flex text-center gap-2 justify-center items-center bg-transparent '>Trending Apps <img className='h-15 w-15' src="https://i.ibb.co.com/407hKPQ/4721635.png" alt="" /></h1>
